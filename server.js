...
// ADD THIS LINE: It lets your separate route files use the walkie-talkie!
app.set('io', io);
...
// 👇 UPDATED LINE BELOW: Added '0.0.0.0' to open the server to the Wi-Fi network 👇
server.listen(PORT, '0.0.0.0', () => console.log(`🚀 DCIM Backend Server running on port ${PORT}, listening to Wi-Fi!`));